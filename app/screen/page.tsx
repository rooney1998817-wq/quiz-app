  ...
  return (
    <div className="min-h-screen text-[#2c2c2c]" style={{ backgroundColor: '#faf8f3' }}>
      {room?.status === 'active' && currentQuestion ? (
        <div className="flex h-screen min-h-0 flex-col items-center overflow-y-auto p-8 pt-8 pb-8 fade-in">
          <div className="mb-8 flex-shrink-0 text-center">
            <h1 className="mb-6 text-6xl font-bold leading-relaxed text-black">{currentQuestion.question_text}</h1>
          ...
          <div className="grid w-full max-w-6xl flex-shrink-0 grid-cols-2 gap-8">
        ...
        <div className="flex h-screen min-h-0 flex-col items-center overflow-y-auto p-8 pt-8 pb-8 fade-in">
          ...
          <div className="mt-12 flex-shrink-0 text-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 max-w-4xl mx-auto">
                    {playersToShow.map((player) => {
                      ...
                      const rankStyle = isTop3 && player.rank <= 3 ? rankColors[player.rank - 1] : { bg: 'bg-white', border: 'border-[#f4e4bc]', text: 'text-[#2c2c2c]', medal: '', size: 'text-4xl' };
